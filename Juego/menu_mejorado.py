...
def comenzar_nuevo_juego():
    ...
    menu_mejorado = subprocess.Popen([sys.executable, 'peleas2.py'])

def mostrar_opciones():
    print (" Función que muestra un nuevo juego.")
    menu_mejorado = subprocess.Popen([sys.executable, 'peleas.py'])
...
if __name__ == '__main__':
    ...
    salir = False
    opciones = [
        ("1 Jugador", comenzar_nuevo_juego),
        ("2 jugadores", mostrar_opciones),
        ("Creditos", creditos),
